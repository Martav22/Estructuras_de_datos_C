...
typedef void (*destroy_element_function_typel)(void*);
typedef void* (*copy_element_function_typel)(const void*);
typedef int (*print_element_function_typel)(FILE *, const void*);
typedef int (*cmp_element_function_typel)(const void*, const void*);
